...
final class FlutterBluePlusDarwin extends FlutterBluePlusPlatform {
  ...
  ///
  final _onwillRestoreStateController = StreamController<BmDevicesList>.broadcast();

  @override
  Stream<BmDevicesList> get onWillRestoreState {
    return _onwillRestoreStateController.stream;
  }
  ...
  Future<void> _methodCallHandler(
    ...
    // handle method call
    switch (call.method) {
      case 'OnWillRestoreState':
        return _onwillRestoreStateController.add(
