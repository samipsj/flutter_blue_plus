...
class BluetoothEvents {
  ...
  Stream<OnWillRestoreStateEvent> get onWillRestoreState {
    return FlutterBluePlusPlatform.instance.onWillRestoreState.map((p) => OnWillRestoreStateEvent(p));
  }
}
...
class OnWillRestoreStateEvent {
  final BmDevicesList _response;
